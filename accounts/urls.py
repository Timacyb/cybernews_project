...
from .views import user_login, dashboard_views, user_register, SignUpView, edit_user, EditUserView
...
urlpatterns = [
    ...
    path('password-reset/<uibd64>/<token>/', PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
